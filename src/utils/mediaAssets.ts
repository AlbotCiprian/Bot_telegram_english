...
const MEDIA_FILE_ALIASES: Record<string, string[]> = {
  ...
  "Metoda_noastra_mobile_fit_v2.mp4": ["Metoda_noastra_mobile_fit_v2.mp4", "Metoda_noastra_mobile_fit.mp4", "Metoda_noastra_mobile_crop.mp4", "Metoda_noastra_optimized.mov", "Metoda_noastra_optimized.MOV", "Metoda_noastra_optimized.mp4", "Metoda_noastra.MOV", "Metoda_noastra.mp4", "method-v5-fit.mp4", "method-v4-iphone.mp4", "method-v3-mobile.mp4", "method-v2-vertical.mp4", "method.mp4", "Video_metda_depredare!.mp4"],
  "Metoda_noastra_mobile_fit.mp4": ["Metoda_noastra_mobile_fit.mp4", "Metoda_noastra_mobile_fit_v2.mp4", "Metoda_noastra_mobile_crop.mp4", "Metoda_noastra_optimized.mov", "Metoda_noastra_optimized.MOV", "Metoda_noastra_optimized.mp4", "Metoda_noastra.MOV", "Metoda_noastra.mp4", "method-v5-fit.mp4", "method-v4-iphone.mp4", "method-v3-mobile.mp4", "method-v2-vertical.mp4", "method.mp4", "Video_metda_depredare!.mp4"],
  "Metoda_noastra_mobile_crop.mp4": ["Metoda_noastra_mobile_crop.mp4", "Metoda_noastra_mobile_fit_v2.mp4", "Metoda_noastra_mobile_fit.mp4", "Metoda_noastra_optimized.mov", "Metoda_noastra_optimized.MOV", "Metoda_noastra_optimized.mp4", "Metoda_noastra.MOV", "Metoda_noastra.mp4", "method-v5-fit.mp4", "method-v4-iphone.mp4", "method-v3-mobile.mp4", "method-v2-vertical.mp4", "method.mp4", "Video_metda_depredare!.mp4"],
